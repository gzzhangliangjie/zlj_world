...
鸡翅膀:原版 1×4×6px,挂在躯干侧面(内侧面对躯干是背面剔除,无共面问题);翅膀顶面矩形 (25,13,1,6) 在原皮肤中透明,补丁脚本已填羽白 (242,224,208)。
...
- **版本号 `Game.BuildId`**(如 2026-09-13c)显示在 HUD 右下角——GitHub Pages 对 index.html 也有 ≤10 分钟缓存,玩家报"改了没生效"先让其 Ctrl+F5 并核对角落 build 号。
